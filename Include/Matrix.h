...
struct Matrix
{
    ...
    static Matrix Scale(Point2 const &P) { return Scale(P.x, P.y); }
    ...
    static Matrix Translate(Point2 const &P) { return Translate(P.x, P.y); }
...
//        return Vector2(R.x/R.z, R.y/R.z);
    ...
    static Matrix ScaleRotateTranslate(float sx, float sy, float angle, Point2 const &translate)
    {
